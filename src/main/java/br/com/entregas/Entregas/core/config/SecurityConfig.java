    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "usuario/detail/**").hasAnyRole("BUSINESSPERSON", "CUSTOMER")
                        .requestMatchers(HttpMethod.GET, "usuario/validate/account/**").permitAll()                        
                        .requestMatchers(HttpMethod.PATCH, "usuario/close/account/**").hasAnyRole("BUSINESSPERSON", "CUSTOMER")
                        .requestMatchers(HttpMethod.PATCH, "usuario/update/user/**").hasAnyRole("BUSINESSPERSON", "CUSTOMER")
