...
public class DeliveymanController {
    ...
    public DeliverymanDetailDto registerOneDeliveryman(
            @Validated(GroupValidation.Create.class) @RequestBody DeliverymanSaveDto newDeliveryman) {
        return service.save(newDeliveryman);
    }

    @PatchMapping("/update/{id}")
    public DeliverymanDetailDto patchOneDeliveryman(@RequestBody DeliverymanSaveDto newDeliveryman, @PathVariable String id) {
